...
<body>
	<div id="htm8">
		<div class="tool">
			<form action="/Den/allJsp/Deal" method="post" class="login-form">
							...
							<c:choose>
								<c:when test="${list.isDeal=='true' && list.isDelete != true}">
									<tr>
										...
										<td><a href="/Den/allJsp/deleteAppo?ona=${list.orderNumber}">删除<i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a></td>
									</tr>
								</c:when>					
							</c:choose>
						</c:forEach>
